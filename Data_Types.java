public class Data_Types {
    public static void main(String[] args) {
        ...
        // All the primitive data types of Java.
        ...
        double f = 789.52; // to store fractionl numbers & the range is from 15 decimal digits. It takes 8 bytes of memory space.

        char g = 'A'; // to store characters (e.g - 'a', 'b') & range is from 0 to 65,535 (256 ASCII + Remainings are UNICODE). It takes 2 bytes (16 bits) of memory space

        boolean h = true; // to store true or false values & it takes 1 byte of memory space.
    }
}
